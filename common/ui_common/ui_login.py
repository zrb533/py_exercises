...
class TestUILogin(unittest.TestCase):
    ...
    def test_login(self):
        ...
        self.remember_me_checked = self.browser.find_element_by_class_name("ant-checkbox-input").get_property("checked")
        if self.remember_me_checked:
            self.browser.find_element_by_xpath('//*[@id="root"]/div/div[1]/div[2]/div/form/div[5]/div/div/span/button').click()
        else:
        ...
        self.browser.find_element_by_xpath('//*[@id="root"]/div/div/div[2]/div[1]/div/div/span/span[2]').click()
        self.user_name = self.browser.find_element_by_xpath('//*[@id="root"]/div/div/div[2]/div[1]/div/div/span/span[2]').text
        self.browser_cookies = self.browser.get_cookies()
        print(self.browser_cookies)
